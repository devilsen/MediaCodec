...
public class OpenGLContext {
    ...
    public OpenGLContext(Surface surface) {
    ...
    private void eglSetup() {
        ...
        if (mSurface != null) {
            ...
            mEGLSurface = EGL14.eglCreateWindowSurface(mEGLDisplay, configs[0], mSurface, surfaceAttributes, 0);
        } else {
            ...
            mEGLSurface = EGL14.eglCreatePbufferSurface(mEGLDisplay, configs[0], PbufferAttributes, 0);
        }
    ...
    /**
     * Makes our EGL context and surface resign.
     */
    public void resignCurrentContext() {
